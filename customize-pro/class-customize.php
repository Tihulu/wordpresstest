 ...
 * @access public
 */
final class cafeteria_lite_Customize {
	...
	public function cafeteria_lite_sections( $manager ) {
		...
		$manager->register_section_type( 'cafeteria_lite_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new cafeteria_lite_Customize_Section_Pro(
				$manager,
				'cafeteria-lite',
				array(
	...
	public function cafeteria_lite_enqueue_control_scripts() {
		...
		wp_enqueue_script( 'cafeteria-lite-customize-controls', trailingslashit( get_template_directory_uri() ) . 'customize-pro/customize-controls.js', array( 'customize-controls' ) );

		wp_enqueue_style( 'cafeteria-lite-customize-controls', trailingslashit( get_template_directory_uri() ) . 'customize-pro/customize-controls.css' );
	}
}

// Doing this customizer thang!
cafeteria_lite_Customize::cafeteria_lite_get_instance();